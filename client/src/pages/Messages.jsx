          ...
          {conversations.map((conversation) => {
            ...
            return (
              <Link
                ...
                className={`flex items-center gap-4 rounded-2xl border p-4 transition hover:border-indigo-200 hover:shadow-sm dark:hover:border-indigo-900/60 ${
                  hasUnread
              ...
              >
                ...
                {user.profileImage ? (
                  ...
                  <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-indigo-100 font-semibold text-indigo-600 dark:bg-indigo-500/20 dark:text-indigo-300">
                    {initial}
                  </div>
                )}
